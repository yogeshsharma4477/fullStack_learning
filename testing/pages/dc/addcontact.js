...
import { Android_CODE_ARR, IOS_CODE_ARR, MOBILE_NUMBER_REGEX, TOUCH_CODE_ARR, WEB_CODE_ARR, checkBot, fetchIP, fetchSourceCode, fetchUserProfileData, haveSameParams, objToQueryString, removeRepetitiveQueryParams, sanitizeParamValue, sanitizeParams, setSourceCodeFromServerSide, verifyUserSID } from '@/utils/commonFunc';
...
function index(props) {
  ...
  return (
    <>
      <Dclanding loggedInMobile={mobileNumberVal} logWorker={logWorker} />
    </>
  )
}
