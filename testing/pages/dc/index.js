...
import Dclanding from '@/components/DC/landing'
import { Android_CODE_ARR, setSourceCodeFromServerSide, IOS_CODE_ARR, MOBILE_NUMBER_REGEX, TOUCH_CODE_ARR, WEB_CODE_ARR, checkBot, fetchIP, fetchSourceCode, fetchUserProfileData, haveSameParams, objToQueryString, removeRepetitiveQueryParams, sanitizeParamValue, verifyUserSID, genrateAccessToken, sanitizeParams } from '@/utils/commonFunc';
...
import { handleDcLogData, handleLogData } from '@/components/DC/commonAPI';
...
function index(props) {
  ...
  async function logWorker(type, docid = "") {
    ...
    try {
      ...
      console.log(error.message,"logdata")
    }
  }
  useEffect(() => {
